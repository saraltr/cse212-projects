...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue doesn't follow the correct rotation of people as GetNextPerson() is not returning people in the expected order
    ...
    // Defect(s) Found: GetNextPerson() is not returning people in the expected order here neither
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim should have infinite turns but he is not being re-added correctly, Sue appears too early 
    ...
    // Defect(s) Found: People with negative turns are not treated as infinite, Tim is skipped
